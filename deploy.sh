...
# Smart cPanel Deployer - Production Linux/macOS client
...
prompt_config() {
    section "Smart cPanel Deployer · First-time configuration"
    local v
...
print_banner() {
    printf '\n%b' "$C_BOLD$C_CYAN"
    printf '  ╔══════════════════════════════════════════════════════╗\n'
    printf '  ║              Smart cPanel Deployer                 ║\n'
    printf '  ║        production deployment · Linux/macOS         ║\n'
    printf '  ╚══════════════════════════════════════════════════════╝\n'
    printf '%b\n' "$C_RESET"
}
...
watch_mode() {
    ...
    while true; do
        ...
        if "$SCRIPT_DIR/deploy.sh" "${child_args[@]}"; then
